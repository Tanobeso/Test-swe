...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica emotiva
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Emotiva" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
\end{enumerate}
\textbf{Estensioni}
\begin{itemize}
    \item Nel caso in cui l'utente voglia solamente visualizzare il feedback
    senza che il testo venga riadattato:
    \begin{enumerate}
        \item L'utente rifiuta la riadattatura del testo
        \item L'utente effettua eventuali modifiche manuali al testo seguendo il feedback visualizzato
        \item L'utente chiude il feedback visualizzato
    \end{enumerate}
\end{itemize}
...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica neutra ed imparziale
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Neutra" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica ottimista
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Ottimista" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica da avvocato del diavolo
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Devil's Advocate" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica sull'originalità
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Originalità" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
...
\subsubsection{UC8.6 - Visione Logica e Struttura}
\textbf{Attori principali}
\begin{itemize}
    \item Utente
\end{itemize}
...
\textbf{Postcondizioni}
\begin{itemize}
    \item L'intero testo viene riadattato sulla base di una critica su logica e struttura
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva la funzionalità "Critica Testo - Visione Logica e Struttura" 
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
    \item L'utente visualizza il feedback della critica
    \item Il testo viene sostituito con la versione riadattata sulla base del feedback  
