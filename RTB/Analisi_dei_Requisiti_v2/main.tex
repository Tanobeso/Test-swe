...
\begin{tikzpicture}
    ...
    \tikzumlset{font=\small}
        ...
        \umlusecase[name=UC252,x=0,y=-1.6,align=center]{\textbf{UC8.2 - Visione Neutra} \\ (Cappello Bianco)}
        \umlusecase[name=UC253,x=0,y=-3.2,align=center]{\textbf{UC8.3 - Visione Ottimista} \\ (Cappello Giallo)}
        \umlusecase[name=UC254,x=0,y=-4.8,align=center]{\textbf{UC8.4 - Visione \textit{Devil's Advocate}} \\ (Cappello Nero)}
        \umlusecase[name=UC255,x=0,y=-6.4,align=center]{\textbf{UC8.5 - Visione Originalità} \\ (Cappello Verde)}
        \umlusecase[name=UC256,x=0,y=-8,align=center]{\textbf{UC8.6 - Visione Logica e Struttura} \\ (Cappello Blu)}
