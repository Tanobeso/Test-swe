...
\subsubsection*{UC3 - Ricerca Nota}
\addcontentsline{toc}{subsubsection}{UC3 - Ricerca Nota}
\begin{center}
\begin{tikzpicture} 
\begin{umlsystem}[x=5, fill=white!10]{Sistema}
  \umlusecase[x=0, y=4, name=ricerca]{UC3 - Ricerca Nota}
\end{umlsystem}
...
\begin{enumerate}
    ...
    \item L'utente specifica i termini della ricerca
