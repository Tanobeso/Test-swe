...
\subsection{UC3 - Riassumere testo con LLM}
\begin{center}
\begin{tikzpicture} 
\begin{umlsystem}[x=6, fill=white!10]{Sistema}
...
\begin{itemize}
    \item L'utente è connesso al sistema
    \item L'utente seleziona una porzione del testo o l'intero testo e richiede che venga riscritto in modo differente
\end{itemize}
\textbf{Postcondizioni}
\begin{itemize}
    \item Il testo viene riscritto in modo diverso
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva il comando "Riscrivi testo"
    \item L'utente seleziona come vuole che venga riscritto il testo (miglioramento, sistemazione grammaticale, cambio tono...)
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
...
\begin{itemize}
    \item L'utente è connesso al sistema
    \item L'utente seleziona una porzione del testo o l'intero testo e richiede che venga tradotto in un'altra lingua
\end{itemize}
\textbf{Postcondizioni}
\begin{itemize}
...
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente attiva il comando "Traduci testo"
...
\subsection{UC6 - Creazione intero testo con LLM}
\begin{center}
\begin{tikzpicture} 
\begin{umlsystem}[x=6, fill=white!10]{Sistema}
  \umlusecase[x=0, y=4, name=creazione]{UC6 - Creazione intero testo con LLM}
\end{umlsystem}
...
\begin{itemize}
    \item L'utente è connesso al sistema
    \item L'utente inserisce una descrizione del testo che vuole generare nell'area dedicata
\end{itemize}
\textbf{Postcondizioni}
\begin{itemize}
    \item Viene generato un intero testo sulla base della descrizione fatta dall'utente
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente scrive una descrizione del testo che vuole ottenere nell'apposita area per la generazione di testo tramite LLM
    \item Il sistema invia la richiesta all'API dell'LLM
    \item Il sistema riceve la risposta dall'LLM
...
\textbf{Postcondizioni}
\begin{itemize}
    \item La nota viene salvata sul filesystem dell'applicazione
\end{itemize}
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente decide la posizione in cui verrà salvata la nota
    \item La nota viene salvata nel filesystem dell'applicazione
\end{enumerate}
